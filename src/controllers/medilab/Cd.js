    ...
    consulta(req, res){
        var retorno = function(){
            ...
            return new Promise(function(resolve, reject){
                const sql = " SELECT first 200 r.NUMERO_EXAME, (r.NOME) as paciente, r.DATA_EXAME,r.MODALIDADE_EXAME, "+
                ...
                Firebird.attach(conn, (erro, db)=>{
                    ...
                    db.query(sql, [req.query.name+'%'], (erro, result) => {
                        ...
                        result.map((n) => {
                            ...
                            paciente.push({
                                numero_exame: (String(n.numero_exame)==="undefined") ? '' : String(n.numero_exame),
                                nome: (String(n.paciente)==="undefined")? '': String(n.paciente),
                                data: (String(n.data_exame)==="undefined")? '': String(n.data_exame),
                                modalidade: (String(n.modalidade_exame)==="undefined")? '':String(n.modalidade_exame),
                                ...
                                accession: (String(n.accession)==="undefined")?'': String(n.accession),
                                storage: (String(n.storage)==="undefined")?'': String(n.storage),
                                numero_cd: (String(n.numero_cd)==="undefined")?'': String(n.numero_cd),
